...
import { SweepName, ISweep, ISweepIdea } from "../../../interfaces/Sweep.interface";

const METHOD_NAME_RUN = "sweepCoreService run";
 ...
 */
export class SweepCoreService implements TSweep {
  private readonly loggerService = inject<TLoggerService>(TYPES.loggerService);
  private readonly sweepConnectionService = inject<SweepConnectionService>(
    TYPES.sweepConnectionService
  );
  private readonly sweepValidationService = inject<SweepValidationService>(
...
export default SweepCoreService;
