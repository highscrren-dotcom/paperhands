...
### __@WAIT_FOR_INIT_SYMBOL@5288

```ts
__@WAIT_FOR_INIT_SYMBOL@5288: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5289

```ts
__@WRITE_SAFE_SYMBOL@5289: IWrappedQueuedFn<symbol | void, [line: string]>
```
