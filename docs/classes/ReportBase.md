...
### __@WAIT_FOR_INIT_SYMBOL@5553

```ts
__@WAIT_FOR_INIT_SYMBOL@5553: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5554

```ts
__@WRITE_SAFE_SYMBOL@5554: IWrappedQueuedFn<symbol | void, [line: string]>
```
