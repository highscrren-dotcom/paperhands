...
### __@WAIT_FOR_INIT_SYMBOL@5546

```ts
__@WAIT_FOR_INIT_SYMBOL@5546: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5547

```ts
__@WRITE_SAFE_SYMBOL@5547: IWrappedQueuedFn<symbol | void, [line: string]>
```
