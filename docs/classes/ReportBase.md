...
### __@WAIT_FOR_INIT_SYMBOL@5273

```ts
__@WAIT_FOR_INIT_SYMBOL@5273: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5274

```ts
__@WRITE_SAFE_SYMBOL@5274: IWrappedQueuedFn<symbol | void, [line: string]>
```
