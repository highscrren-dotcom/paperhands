...
### __@WAIT_FOR_INIT_SYMBOL@5264

```ts
__@WAIT_FOR_INIT_SYMBOL@5264: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5265

```ts
__@WRITE_SAFE_SYMBOL@5265: IWrappedQueuedFn<symbol | void, [line: string]>
```
