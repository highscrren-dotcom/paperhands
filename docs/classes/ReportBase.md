...
### __@WAIT_FOR_INIT_SYMBOL@5605

```ts
__@WAIT_FOR_INIT_SYMBOL@5605: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5606

```ts
__@WRITE_SAFE_SYMBOL@5606: IWrappedQueuedFn<symbol | void, [line: string]>
```
