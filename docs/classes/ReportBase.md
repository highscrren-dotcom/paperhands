...
### __@WAIT_FOR_INIT_SYMBOL@5261

```ts
__@WAIT_FOR_INIT_SYMBOL@5261: (() => Promise<void>) & ISingleshotClearable<() => Promise<void>>
```
...
### __@WRITE_SAFE_SYMBOL@5262

```ts
__@WRITE_SAFE_SYMBOL@5262: IWrappedQueuedFn<symbol | void, [line: string]>
```
