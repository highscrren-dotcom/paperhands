...
export const order_stop_fields: TypedField[] = [
    {
            ...
            },
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        title: t("Stop Reason"),
                        readonly: true,
                        isVisible: (obj) => !!obj.reason,
                        compute: (obj) =>
                            obj.reason === "deleted"
                                ? t("Deleted (order not found)")
                                : t("Exhausted (check attempts spent)"),
                    },
                    {
                        type: FieldType.Text,
                        outlined: false,
...
export default order_stop_fields;
