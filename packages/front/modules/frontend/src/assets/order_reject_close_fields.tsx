...
export const order_reject_close_fields: TypedField[] = [
    {
            ...
            },
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        title: t("Attempt"),
                        readonly: true,
                        isVisible: (obj) => obj.attempt != null,
                        compute: (obj) => `${obj.attempt}`,
                    },
                    {
                        type: FieldType.Text,
                        outlined: false,
                        ...
                        readonly: true,
                        isVisible: (obj) => !!obj.message,
                        compute: (obj) => obj.message || t("Not specified"),
                    },
                    {
                        type: FieldType.Text,
                        outlined: false,
            ...
            },
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        phoneColumns: "12",
                        name: "closeReason",
                        title: t("Close Reason"),
                        readonly: true,
                        compute: (obj) => obj.closeReason || t("Not specified"),
                    },
                    {
                        type: FieldType.Text,
                        outlined: false,
...
export default order_reject_close_fields;
