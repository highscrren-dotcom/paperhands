...

    {
      ...
      if (backtestTarget) {
        ...
        return {
          ...
          portfolioStdDev: currentHeat.portfolioStdDev,
          portfolioSortinoRatio: currentHeat.portfolioSortinoRatio,
          ...
          symbols: currentHeat.symbols.map(({
            symbol, totalPnl, winRate, profitFactor, maxDrawdown, expectancy, totalTrades,
            sortinoRatio, calmarRatio, recoveryFactor, sharpeRatio, annualizedSharpeRatio,
            certaintyRatio, expectedYearlyReturns, tradesPerYear, avgPnl, stdDev,
            avgWin, avgLoss, maxWinStreak, maxLossStreak, avgPeakPnl, avgFallPnl,
            peakProfitPnl, maxDrawdownPnl, avgDuration, medianPnl,
            avgConsecutiveWinPnl, avgConsecutiveLossPnl, avgWinDuration, avgLossDuration,
            medianStepSize, buyerPressure, sellerPressure, buyerStrength, sellerStrength,
