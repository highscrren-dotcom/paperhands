...
addFrameSchema({
  ...
  // Расширена 21.07 под RSS-пул (№106): последний вердикт 21.07 07:28Z; его
  // 24ч-таймаут обрезается рамкой — как и раньше (см. README).
  endDate: new Date("2026-07-21T09:00:00Z"),
  note: "News stand 6–21 Jul 2026 (RSS-пул)",
});
