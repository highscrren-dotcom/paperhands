...
addFrameSchema({
  ...
  // Правая граница фиксирована в прошлом (прогон стенда 17.07 ~13:30Z):
  // 24ч-таймаут последнего item'а (16.07 16:55Z) обрезается рамкой — см. README.
  endDate: new Date("2026-07-17T12:00:00Z"),
  note: "News stand 6–17 Jul 2026",
});
